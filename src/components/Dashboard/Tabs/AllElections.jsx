                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="space-y-2">
                      {userOwnsElection ? (
                        <>
                          {/* ✅ OWNER: Show all buttons - View, Share, Clone, Edit, Delete */}
                          {/* Row 1: View & Share */}
                        ...
                        <>
                          ...
                          {/* ✅ Create Election button for non-owners */}
                          <button
                            onClick={handleCreateElection}
                            className="w-full flex items-center justify-center gap-1 px-3 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded hover:from-blue-600 hover:to-purple-600 text-sm font-medium transition-colors"
                          >
...
//last workable code only to edit delete and clone for logged in user 
// //All Elections - Shows ALL elections for any authenticated user
// //Edit and Delete only visible for elections owned by logged-in user
// import React, { useState, useEffect, useCallback } from 'react';
// import { useNavigate } from 'react-router-dom';
