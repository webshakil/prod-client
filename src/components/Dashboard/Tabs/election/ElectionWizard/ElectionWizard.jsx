...
export default function ElectionWizard({ creatorType, onClose, eligibility }) {
  ...
  const [electionData, setElectionData] = useState({
    ...
    topic_video: null,
    topic_video_url: '',
    required_watch_duration_minutes: 0, // ✅ ADD THIS - Default: no requirement
    logo: null,
    start_date: '',
    start_time: '',
    end_date: '',
    ...
    lottery_config: {
      ...
      prize_distribution: [], // ✅ ADD THIS - Array of {rank, percentage}
    },
