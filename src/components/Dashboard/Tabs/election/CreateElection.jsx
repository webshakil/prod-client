      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-2 border-purple-100">
          ...
          <div className="space-y-2.5">
            ...
            <FeatureItem enabled={eligibility.canCreatePaidElections} text="Gamified Election Prizes" />
...
function CreatorTypeCard({ selected, onClick, icon, title, description }) {
  return (
    <button
      onClick={onClick}
    ...
    >
      <div className={`mb-3 ${selected ? 'text-blue-600' : 'text-gray-600'}`}>
        {icon}
      </div>
