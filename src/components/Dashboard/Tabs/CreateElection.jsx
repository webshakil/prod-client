...
export default function CreateElection() {
  ...
  const fetchEligibility = async () => {
    ...
    try {
      ...
      // 6. 🔥 UPDATE SUBSCRIPTION SLICE - Processing Fee (CRITICAL)
      if (eligibilityData.processingFeePercentage !== undefined && eligibilityData.processingFeePercentage !== null) {
        ...
        console.log('✅ Processing Fee set to:', processingFeeValue + '%');
      } else {
        // Default to 0 if not provided
        dispatch(setProcessingFee(0));
        console.log('⚠️ Processing Fee not provided, defaulting to 0%');
      }
      ...
      if (eligibilityData.participationFeePercentage !== undefined && eligibilityData.participationFeePercentage !== null) {
        ...
        console.log('✅ Participation Fee set to:', participationFeePercentageValue + '%');
      }
      ...
      console.log('💰 Auth & Subscription Slice - Amount:', eligibilityData.amount, eligibilityData.currency);
