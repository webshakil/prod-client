...
export default function UserRoleAssignment() {
  ...
  const [deleteAssignment, { isLoading: deleting }] = useDeleteRoleAssignmentMutation(); // ✅ NEW: Delete hook
  ...
  // ✅ NEW: Handle delete assignment (permanent removal)
...
//                 // ✅ If current user, reload to update sidebar
...
// import { toast } from 'react-toastify';
// import { Search, UserPlus, X, Loader, Trash2, Calendar, User, Shield, ChevronDown, ChevronUp } from 'lucide-react';
// //import { useAssignRoleMutation, useDeactivateRoleAssignmentMutation, useGetRoleAssignmentsQuery } from '../../../redux/api/role/assignmentApi';
// //import { formatAssignmentType, formatDate, getRoleBadgeColor } from '../../../utils/roleHelpers';
// //import { useGetAllRolesQuery, useSearchUsersQuery } from '../../../redux/api/role/roleApi';
// //import { useAssignRoleMutation, useDeactivateRoleAssignmentMutation, useGetAllRolesQuery, useGetRoleAssignmentsQuery, useSearchUsersQuery } from '../../../../redux/api/role/roleApi';
// import { 
//   useGetAllRolesQuery, 
//   useSearchUsersQuery 
// } from '../../../../redux/api/role/roleApi';
...
//                                       </div>
//                                       <button
//                                         onClick={() => handleDeactivate(user.user_id, role.role_name)}
...
// //import { useSearchUsersQuery } from '../../../redux/api/role/roleApi';
// import { useAssignRoleMutation, useDeactivateRoleAssignmentMutation, useGetAllRolesQuery, useGetRoleAssignmentsQuery, useSearchUsersQuery } from '../../../../redux/api/role/roleApi';
// import { formatAssignmentType, formatDate, getRoleBadgeColor } from '../../../../utils/roleHelpers';
// export default function UserRoleAssignment() {
//   // State
...
//       await assignRole({
//         user_id: selectedUser.user_id,
//         role_id: parseInt(assignFormData.roleId),
//         assignment_type: assignFormData.assignment_type,
//         expires_at: assignFormData.expires_at || null,
//         metadata: assignFormData.reason ? { reason: assignFormData.reason } : null,
//       }).unwrap();
...
//         {usersSearchData ? 'No users found' : 'Start typing to search...'}
//       </div>
//     )}
//   </div>
// )}
...
// // } from '../../../redux/api/role/assignmentApi';
// //import { useGetAllRolesQuery } from '../../../redux/api/role/roleApi';
// //import { getRoleBadgeColor, formatAssignmentType, formatDate } from '../../../utils/roleHelpers';
// import { Search, UserPlus, X, Loader, Trash2, Calendar, User } from 'lucide-react';
// import { useAssignRoleMutation, useDeactivateRoleAssignmentMutation, useGetRoleAssignmentsQuery } from '../../../../redux/api/role/assignmentApi';
// import { formatAssignmentType, formatDate, getRoleBadgeColor } from '../../../../utils/roleHelpers';
// import { useGetAllRolesQuery } from '../../../../redux/api/role/roleApi';
...
//     if (!window.confirm('Are you sure you want to deactivate this role assignment?')) return;
...
//               <p className="text-2xl font-bold text-gray-900">
//                 {assignmentsData?.data?.filter(a => a.is_active).length || 0}
//               </p>
//             </div>
//           </div>
//         </div>
...
//                     <div className="flex items-center gap-3">
//                       <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">
//                         {assignment.user_email?.[0]?.toUpperCase() || 'U'}
//                       </div>
//                       <div>
//                         <p className="text-sm font-medium text-gray-900">
...
//                   </td>
//                   <td className="px-6 py-4 whitespace-nowrap">
//                     <span className={`inline-block px-3 py-1 text-xs font-medium rounded-full border ${getRoleBadgeColor(assignment.role_name)}`}>
