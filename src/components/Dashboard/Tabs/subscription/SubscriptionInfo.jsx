// src/components/Dashboard/Tabs/subscription/SubscriptionInfo.jsx
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <CreditCard size={32} />
            <div>
              <h3 className="text-xl font-bold">{subscription.plan_name || 'Subscription'}</h3>
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-gray-500">{subscription.payment_type || 'Recurring'}</p>
          </div>
        </div>

        {/* End Date */}
        <div className="flex items-start gap-3">
          <div className={`${isActive ? 'bg-purple-100' : 'bg-red-100'} p-3 rounded-lg flex-shrink-0`}>
            <Calendar className={`${isActive ? 'text-purple-600' : 'text-red-600'}`} size={24} />
          </div>
          <div className="min-w-0">
        ...
        <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
          <div className="flex items-center justify-between flex-wrap gap-4 text-sm">
            <div>
              ...
              <span className="font-medium text-gray-900 capitalize">{subscription.gateway}</span>
            </div>
