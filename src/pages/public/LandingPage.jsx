...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      title: t('landing.features.secureVoting.title'),
      description: t('landing.features.secureVoting.description'),
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: t('landing.features.realTimeAnalytics.description'),
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('landing.features.flexiblePricing.title'),
      description: t('landing.features.flexiblePricing.description'),
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const stats = [
    { value: '10K+', label: t('landing.stats.electionsCreated') },
    { value: '1M+', label: t('landing.stats.votesCast') },
    { value: '150+', label: t('landing.stats.countries') },
                ...
                <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{t('landing.hero.uptime')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{t('landing.hero.activeVoters')}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Button variant="primary" onClick={handleGetStarted} className="px-8 py-4 text-lg">
              {t('landing.howItWorks.startFirstElection')}
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">{t('landing.testimonials.testimonial1.name')}</p>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">{t('landing.testimonials.testimonial2.name')}</p>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">{t('landing.testimonials.testimonial3.name')}</p>
