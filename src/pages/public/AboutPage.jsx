...
const AboutPage = () => {
  ...
  const stats = [
    { value: '2020', label: t('about.stats.founded') },
    { value: '50+', label: t('about.stats.teamMembers') },
    { value: '150+', label: t('about.stats.countriesServed') },
    { value: '10K+', label: t('about.stats.organizations') },
  ];
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('about.mission.storyTitle')}</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              {t('about.mission.storyParagraph1')}
            </p>
            <p className="text-gray-700 leading-relaxed">
              {t('about.mission.storyParagraph2')}
            </p>
          </div>
        </div>
      </section>
