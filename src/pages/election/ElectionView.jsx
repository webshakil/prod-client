  ...
  return (
    <div className="flex-shrink-0 w-64 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group border border-gray-100">
      ...
      <div className="relative h-32 overflow-hidden">
        ...
        <div className="absolute bottom-2 right-2">
          <span 
            ...
            title={`Recommended by: ${similaritySource === 'shaped_ai' ? 'Shaped AI (MiniLM-L6-v2)' : similaritySource}`}
          >
      ...
      <div className="p-4">
        ...
        {/* Shaped AI Verification Badge */}
        {similaritySource === 'shaped_ai' && (
          <div className="flex items-center gap-1 mb-2 text-xs text-purple-600 bg-purple-50 px-2 py-1 rounded">
            <FaCheckCircle className="text-green-500" />
            <span>Verified Shaped AI</span>
          </div>
        )}
...
// Shaped AI Info Modal
const ShapedAIInfoModal = ({ isOpen, onClose, apiResponse }) => {
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Election titles and descriptions are converted into 384-dimensional vectors using the sentence-transformers/all-MiniLM-L6-v2 model</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Cosine similarity is calculated between the current election's embedding and all other elections</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Top matches are returned, filtered by status and end date to show only relevant elections</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-sm">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-2 text-gray-600">Shaped AI</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {apiResponse && (
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Note: Each result contains "similarity_source": "shaped_ai" which proves the recommendation came from Shaped AI
              </p>
            </div>
          )}
...
export default function SimilarElections({ electionId }) {
  ...
  const fetchSimilarElections = async () => {
    ...
    try {
      ...
      // Store the full API response for proof
      setApiResponse(data);
    ...
    <>
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-100">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            {/* Info Button - Shows Proof Modal */}
            <button
              onClick={() => setShowInfoModal(true)}
              className="p-2 rounded-full bg-white shadow-md hover:bg-purple-50 transition-colors group"
              title="View Shaped AI Proof"
            >
              <FaInfoCircle className="text-purple-600 group-hover:text-purple-800" />
            </button>
